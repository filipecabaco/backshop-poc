...
export function Repl(): JSX.Element {
  return (
    <div>
      <Highlight lang={'clojure'} value={code1}/>
      <ReactMarkdown source={`better exception experience on repl add the follow to project.clj`}/>
      <Highlight lang={'clojure'} value={code2}/>
      <ReactMarkdown source={`the above settings will print better stacktrace once things blows up`}/>
      <Highlight lang={'clojure'} value={code3}/>
    </div>
  )}
